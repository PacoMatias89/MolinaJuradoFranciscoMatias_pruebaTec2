...
<html>
    ...
    <body>
        <div class="container">
            <h4>Buscar turno por fecha y estado</h4>

            <form action="FiltradoTurnoFechaEstadoSv" method="GET" class="text-center">
            ...
            <% if (request.getAttribute("FiltradorTurno") != null && !((List<Turno>) request.getAttribute("FiltradorTurno")).isEmpty()) { %>
            ...
            <table class="table ">
                ...
                <tbody>
                    <% for (Turno turno : (List<Turno>) request.getAttribute("FiltradorTurno")) {%>
                    <tr>
                        <td><%= turno.getId()%></td>
                        ...
                        <td>
                            ...
                            <form action="FiltradoTurnoFechaEstadoSv" method="POST">
