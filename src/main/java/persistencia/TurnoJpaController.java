...
public class TurnoJpaController implements Serializable {
    ...
    public TurnoJpaController() {
        emf = Persistence.createEntityManagerFactory("turnosJspPu");
    }
